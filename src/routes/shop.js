...
router.get('/:slug', async (req, res) => {
  const business = await prisma.business.findUnique({
    ...
    select: { slug: true, name: true, logoUrl: true, currency: true, supportPhone: true, category: true, description: true, coverUrl: true, openTime: true, closeTime: true, deliveryInfo: true },
  });
